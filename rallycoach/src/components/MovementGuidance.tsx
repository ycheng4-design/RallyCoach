...
// 3D Bone component - using drei Line for proper rendering
...
export default function MovementGuidance({
  ...
  return (
    <div className="rounded-xl overflow-hidden bg-slate-900 shadow-xl" style={{ width }}>
      ...
      {/* 3D View - Always shown (removed 2D option) */}
      {correctionKeyframe ? (
        <div style={{ height: height + 40 }} className="relative bg-gradient-to-b from-slate-800 to-slate-900">
        ...
        <div style={{ height }} className="bg-slate-800 flex items-center justify-center">
          <p className="text-slate-500 text-sm">No correction guidance available</p>
        </div>
      )}
...
const MISTAKE_EXPLANATIONS: Record<string, Omit<WhyCardProps, 'mistakeType'>> = {
  ...
  INSUFFICIENT_ROTATION: {
    ...
    fix: 'Rotate hips and shoulders 45-90° during backswing',
