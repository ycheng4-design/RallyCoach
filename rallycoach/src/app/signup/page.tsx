  ...
  if (success) {
    return (
      <div className="min-h-screen bg-blue-900/80 backdrop-blur-md flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-md bg-white text-black p-8 rounded-3xl shadow-2xl relative border-t-8 border-green-500 animate-slide-up-modal z-10 text-center">
          ...
          <h2 className="text-2xl font-bold mb-2 text-slate-900">Welcome to the Court!</h2>
          <p className="text-slate-500 mb-6">Your coaching journey begins. Check your email or continue to the dashboard.</p>
          <Link
            href="/dashboard"
            className="inline-block px-6 py-3 bg-blue-700 text-white rounded-xl font-bold hover:bg-blue-800 hover:-translate-y-1 hover:shadow-lg transition-all"
          >
            Go to Dashboard
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-blue-900/80 backdrop-blur-md flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white text-black p-8 rounded-3xl shadow-2xl relative border-t-8 border-blue-600 animate-slide-up-modal z-10">
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-2xl font-bold mb-2 text-slate-900">Start Your Training</h2>
